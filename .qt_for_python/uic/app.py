...
class Ui_Aplicacion(object):
    def setupUi(self, Aplicacion):
        ...
        self.logouts.setGeometry(QtCore.QRect(390, 540, 220, 107))
        ...
        self.dss_name = QtWidgets.QLabel(self.pgn_inicio)
        self.dss_name.setGeometry(QtCore.QRect(745, 610, 241, 21))
        ...
        brush = QtGui.QBrush(QtGui.QColor(85, 87, 83, 128))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.dss_name.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(True)
        self.dss_name.setFont(font)
        self.dss_name.setStyleSheet("color: rgb(85, 87, 83);")
        self.dss_name.setTextFormat(QtCore.Qt.AutoText)
        self.dss_name.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.dss_name.setObjectName("dss_name")
        self.dss_dir = QtWidgets.QLabel(self.pgn_inicio)
        self.dss_dir.setGeometry(QtCore.QRect(745, 630, 241, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(True)
        self.dss_dir.setFont(font)
        self.dss_dir.setStyleSheet("color: rgb(85, 87, 83);")
        self.dss_dir.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.dss_dir.setObjectName("dss_dir")
...
"")
    ...
    def retranslateUi(self, Aplicacion):
        ...
        self.dss_name.setText(_translate("Aplicacion", "Desarrollado por: Jefferson Mora"))
        self.dss_dir.setText(_translate("Aplicacion", "Director: Ing. Carlos Nova"))
